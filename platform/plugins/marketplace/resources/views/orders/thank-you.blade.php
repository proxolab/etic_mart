                ...
                @if (count($orders) > 1)
                    ...
                    <div class="bg-light p-3">
                        <div class="row total-price">
                            ...
                            <div class="col-6">
                                <p class="text-right"> {{ format_price($orders->sum('sub_total')) }} </p>
                            </div>
                        </div>
                        ...
                        <div class="row total-price">
                            ...
                            <div class="col-6">
                                <p class="text-right">{{ format_price($orders->sum('shipping_amount')) }} </p>
                            </div>
                        </div>
                        ...
                        @if ($orders->sum('discount_amount'))
                            <div class="row total-price">
                                ...
                                <div class="col-6">
                                    <p class="text-right">{{ format_price($orders->sum('discount_amount')) }} </p>
                                </div>
                            </div>
                        @endif
                        ...
                        @if (EcommerceHelper::isTaxEnabled())
                            <div class="row total-price">
                                ...
                                <div class="col-6">
                                    <p class="text-right">{{ format_price($orders->sum('tax_amount')) }}</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row total-price">
                            ...
                            <div class="col-6">
                                <p class="total-text raw-total-text text-right"> {{ format_price($orders->sum('amount')) }} </p>
                            </div>
                        </div>
                    </div>
                @endif
